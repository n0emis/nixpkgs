...
- [IXP-Manager](https://www.ixpmanager.org/), a full stack management platform for Internet eXchange Points (IXPs). Available as [services.ixp-manager](#opt-services.ixp-manager.enable).
