{ lib, pkgs, fetchFromGitHub, python3, plugins ? [] }:
...
py.pkgs.buildPythonApplication rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = pname;
      rev = "v${version}";
      sha256 = "sha256-ZmolXfGHg8akxICfU3HdQo1PScCPmp+6x6cabLnsufc=";
    };

    format = "other";

    patches = [
      # Allow setting the STATIC_ROOT from within the configuration
      ./static.patch
    ];
